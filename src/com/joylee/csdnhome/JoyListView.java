 ...
 */
public class JoyListView extends ListView implements OnScrollListener {
    ...
    public JoyListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        headView = (LinearLayout) inflater.inflate(R.layout.pullhead, null);//listview拼接headview
